...
export default function Tweetcard({ contentpro }) {
    ...
    return (
        <>
            {userDetail && ( 
                <div className='flex gap-1 px-3 py-2 text-white  border-y-bw1 border-hash'>
                    <div className="leftcon w-14 py-2">
                        <img src={userDetail.userimg} alt="img" className='w-10 h-10 cursor-pointer rounded-full' onClick={goToProfileParams} />
                    </div>
                    <div className="rightcon w-full py-2 pb-5">
